...
from models import DepthEstimationModel, DrivingPolicyNet, DrivingPolicyNetFast
...
def train_policy(
    ...
    depth_estimator = None if (use_precomputed or not use_depth) else DepthEstimationModel(finetuned_path=dpt_path)
